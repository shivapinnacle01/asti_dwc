...
$(".scheduleBtn").mouseenter(function () {
  $(".firstbtn").show();
});
...
$(".calenderBtn").mouseenter(function () {
  $(".secondbtn").show();
});

$(".calenderBtn").mouseleave(function () {
  $(".secondbtn").hide();
});
...
$(".enquiryBtn").mouseenter(function () {
  $(".fourthbtn").show();
});

$(".enquiryBtn").mouseleave(function () {
  $(".fourthbtn").hide();
});

$(".expertsBtn").mouseenter(function () {
  $(".fifthbtn").show();
});

$(".expertsBtn").mouseleave(function () {
  $(".fifthbtn").hide();
});

$(".applyBtn").mouseenter(function () {
  $(".sixthbtn").show();
});
...
$(".enrollBtn").mouseleave(function () {
  $(".seventhbtn").hide();
});

$(document).ready(function () {
  var contentSection = $(".content-section");
  var navigation = $(".sticky-top");
  ...
  function updateNavigation() {
    contentSection.each(function () {
      ...
      var navigationMatch = $('.sticky-top a[href="#' + sectionName + '"]');
      if (
